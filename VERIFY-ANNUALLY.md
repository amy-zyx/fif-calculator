...
| 4 | The Australian listed share exemption list (approved index, stapled-security exclusions) | `packages/engine/src/data/au-exemption-list.ts` (M2) | not yet built | — |
